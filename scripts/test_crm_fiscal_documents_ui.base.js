...
const browser=fs.readFileSync(path.join(__dirname,'..','web','src','modules','finance','fiscal','browser.js'),'utf8');
const css=fs.readFileSync(path.join(__dirname,'..','web','src','modules','finance','fiscal','styles.css'),'utf8');
let passed=0;
