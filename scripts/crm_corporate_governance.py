...
def apply_crm_corporate_governance() -> int:
    ...
    # Existing Finance domains must remain owners of economic rights and payouts.
    ...
    CSS.write_text(replace_css(CSS.read_text(encoding="utf-8"), "VALTREN CORPORATE GOVERNANCE", MODULE_CSS.read_text(encoding="utf-8")), encoding="utf-8"); update_cache_version()
    print("Jurídico → Societário materializado com estruturas históricas, sócios, holdings, capital, aportes, administradores e atos; explicitamente separado de Participações Econômicas, Repasses e Transações.")
    return 1
