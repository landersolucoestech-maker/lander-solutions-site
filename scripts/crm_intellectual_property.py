...
def apply_crm_intellectual_property() -> int:
    ...
    CSS.write_text(replace_css(CSS.read_text(encoding="utf-8"), "VALTREN INTELLECTUAL PROPERTY", MODULE_CSS.read_text(encoding="utf-8")), encoding="utf-8"); update_cache_version()
    print("Jurídico → Propriedade Intelectual materializado com ativos, registros, titularidade, licenças jurídicas via Contratos e prazos; licenças operacionais permanecem em Administração.")
    return 1
