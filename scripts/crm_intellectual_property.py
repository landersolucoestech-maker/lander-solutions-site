...
MODULE_DIR = ROOT / "web" / "src" / "modules" / "legal" / "intellectual-property"
...
def apply_crm_intellectual_property() -> int:
    ...
    print("Jurídico → Propriedade Intelectual materializado a partir de web/src/modules/legal/intellectual-property.")
    return 1
