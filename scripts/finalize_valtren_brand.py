...
.admin-sidebar{background:#0B1D3A!important;color:#fff!important;border-color:rgba(212,175,55,.42)!important}.admin-sidebar nav button,.admin-preview{color:rgba(255,255,255,.84)!important}.admin-sidebar nav button:hover,.admin-sidebar nav button.active,.admin-preview:hover{color:#D4AF37!important}
.site-footer,footer{background:#FFFFFF!important;color:#0B1D3A!important;border-color:#D9E1E9!important}.site-footer a,footer a{color:#475569!important}.site-footer a:hover,footer a:hover{color:#B8891F!important}
