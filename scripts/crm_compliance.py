...
MODULE_DIR = ROOT / "web" / "src" / "modules" / "legal" / "compliance"
...
def apply_crm_compliance() -> int:
    ...
    print("Jurídico → Compliance materializado a partir de web/src/modules/legal/compliance, sem obrigações fictícias.")
    return 1
